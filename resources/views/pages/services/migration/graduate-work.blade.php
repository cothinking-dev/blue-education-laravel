        ...
        <div class="max-w-7xl mx-auto px-8 lg:px-16 py-14">
            <div class="flex flex-col lg:flex-row gap-12">
                <div class="flex-1">
                    ...
                    <p class="text-base-600 leading-relaxed mb-4 text-pretty">The Subclass 485 lets you live, work, and study in Australia after completing your qualification. It's your bridge from study to career — and to potential permanent residence.</p>
                    <p class="text-base-600 leading-relaxed mb-8 text-pretty">There are two streams:</p>

                    <div class="space-y-6">
                        <div>
                            <h3 class="text-lg font-bold text-base-900 mb-3">Graduate Work Stream</h3>
                            <x-facts-table :rows="[
                        ...
                        <div>
                            <h3 class="text-lg font-bold text-base-900 mb-3">Post-Study Work Stream</h3>
                ...
                <div class="lg:w-[40%]">
                    <div class="bg-primary-50 rounded-corner-lg p-6">
                        <h3 class="font-bold text-base-900 mb-4">Both streams include:</h3>
                        <ul class="space-y-3">
                            <li class="flex items-start gap-3">
                                <span class="text-primary-600 font-bold mt-0.5">&#10003;</span>
                                <span class="text-base-700 text-sm">Work rights in Australia</span>
                            </li>
                            <li class="flex items-start gap-3">
                                <span class="text-primary-600 font-bold mt-0.5">&#10003;</span>
                                <span class="text-base-700 text-sm">Opportunity to gain Australian work experience</span>
                            </li>
                            <li class="flex items-start gap-3">
                                <span class="text-primary-600 font-bold mt-0.5">&#10003;</span>
                                <span class="text-base-700 text-sm"><a href="{{ route('services.migration.permanent-residence') }}" class="text-primary-800 hover:underline font-medium">Pathway to skilled migration &rarr;</a></span>
                            </li>
                            <li class="flex items-start gap-3">
                                <span class="text-primary-600 font-bold mt-0.5">&#10003;</span>
                                <span class="text-base-700 text-sm">Family inclusion options</span>
                            </li>
                        </ul>
                    </div>
                </div>
    ...
    <section class="bg-base-50">
        <div class="max-w-7xl mx-auto px-8 lg:px-16 py-14">
            ...
            <div class="grid sm:grid-cols-3 gap-6" data-animate="stagger">
                <a href="{{ route('services.migration.permanent-residence') }}" class="bg-white rounded-corner-lg border border-base-200 p-6 hover:border-primary-300 hover:shadow-sm transition-all group">
                ...
                <a href="{{ route('services.migration.student-visas') }}" class="bg-white rounded-corner-lg border border-base-200 p-6 hover:border-primary-300 hover:shadow-sm transition-all group">
