<x-layout title="Permanent Residence"
        ...
        <div class="max-w-7xl mx-auto px-8 lg:px-16 py-14">
            ...
            <div class="grid sm:grid-cols-2 gap-6" data-animate="stagger">
                <div class="border border-base-200 rounded-corner-lg p-6 bg-white">
                    ...
                    <h3 class="text-lg font-bold text-base-900 mb-3 text-pretty">Skilled Migration</h3>
                    ...
                    <p class="text-base-500 text-xs text-pretty"><strong>Best for:</strong> Professionals with <a href="{{ route('services.migration.graduate-work') }}" class="text-primary-800 hover:underline">Australian qualifications and work experience</a> who meet or are approaching the points threshold.</p>
                </div>
                ...
                <div class="border border-base-200 rounded-corner-lg p-6 bg-white">
                    ...
                    <h3 class="text-lg font-bold text-base-900 mb-3 text-pretty">Employer Sponsored Migration</h3>
                    <p class="text-base-600 text-sm leading-relaxed mb-4 text-pretty">Your employer nominates you for permanent or temporary residence. We manage the nomination application, labour market testing requirements, and sponsorship compliance throughout.</p>
                    <p class="text-base-500 text-xs text-pretty"><strong>Best for:</strong> Workers with a confirmed job offer from an approved Australian employer who cannot find a suitably skilled local candidate.</p>
                </div>
                ...
                <div class="border border-base-200 rounded-corner-lg p-6 bg-white">
                    ...
                    <h3 class="text-lg font-bold text-base-900 mb-3 text-pretty">Business Migration</h3>
                    <p class="text-base-600 text-sm leading-relaxed mb-4 text-pretty">For business owners, investors, and entrepreneurs planning to establish or invest in Australia. We support business plan development, investment requirement guidance, and state nomination applications.</p>
                    <p class="text-base-500 text-xs text-pretty"><strong>Best for:</strong> Experienced business operators with significant capital or a demonstrated track record in business ownership or management.</p>
                </div>
                ...
                <div class="border border-base-200 rounded-corner-lg p-6 bg-white">
                    ...
                    <h3 class="text-lg font-bold text-base-900 mb-3 text-pretty">Family & Partner Visas</h3>
                    ...
                    <p class="text-base-500 text-xs text-pretty"><strong>Best for:</strong> Anyone with an eligible Australian citizen, permanent resident, or eligible NZ citizen family member or partner.</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="bg-base-50">
        <div class="max-w-7xl mx-auto px-8 lg:px-16 py-14">
            ...
            <div class="grid sm:grid-cols-2 gap-6" data-animate="stagger">
                <a href="{{ route('services.career') }}" class="bg-white rounded-corner-lg border border-base-200 p-6 hover:border-primary-300 hover:shadow-sm transition-all group">
                    <h3 class="font-bold text-base-900 mb-2 group-hover:text-primary-800 transition-colors">Explore career support and employer connections &rarr;</h3>
                    <p class="text-base-600 text-sm text-pretty">Job placement, executive internships, and professional development.</p>
                </a>
                <a href="{{ route('contact') }}" class="bg-white rounded-corner-lg border border-base-200 p-6 hover:border-primary-300 hover:shadow-sm transition-all group">
                    <h3 class="font-bold text-base-900 mb-2 group-hover:text-primary-800 transition-colors">Talk to a migration agent &rarr;</h3>
                    <p class="text-base-600 text-sm text-pretty">Get an honest assessment of your PR pathway and timeline.</p>
                </a>
            </div>
        </div>
    </section>
