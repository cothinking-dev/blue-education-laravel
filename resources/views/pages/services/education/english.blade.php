<x-layout title="English & Foundation Programmes"
    ...
    <x-content-split title="Foundation Studies" :image="asset('images/services-education-english/foundation-studies.webp')" alt="East Asian students in a foundation studies classroom preparing for university">
        <p>Foundation studies in Australia are specially designed pathway programmes that prepare international students for entry into university bachelor degrees. They help you meet academic and English requirements while giving you time to adjust to Australian teaching styles and campus life.</p>

        <h3 class="text-lg font-semibold text-base-800 mb-2 mt-4">What is a Foundation Programme?</h3>
        <p>A foundation programme is usually a 6–12 month course that sits between high school and university. It combines Academic English, study skills and subject units related to your future degree, such as business, engineering, IT, health, science or arts.</p>

        <h3 class="text-lg font-semibold text-base-800 mb-2 mt-4">Who is Foundation Studies for?</h3>
        <x-icon-list>
        ...
        <h3 class="text-lg font-semibold text-base-800 mb-2 mt-4">Key benefits for international students</h3>
        <x-icon-list>
        ...
        <div class="max-w-7xl mx-auto px-8 lg:px-16 py-14">
            ...
            <div class="flex flex-col items-center gap-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4 w-full max-w-3xl">
                    <div class="border border-base-200 rounded-corner-lg p-5 bg-white text-center">
                    ...
                    <div class="border-2 border-dashed border-primary-300 rounded-corner-lg p-5 bg-primary-50/50 text-center">
                        <div class="w-10 h-10 rounded-full bg-primary-50 border-2 border-primary-200 text-primary-800 flex items-center justify-center mx-auto mb-3">
    ...
    {{-- §6 How Blue Education Supports Your English Journey --}}
    <section class="bg-base-50">
        <div class="max-w-7xl mx-auto px-8 lg:px-16 py-14">
            <h2 class="text-3xl font-bold text-base-900 mb-4 text-pretty" data-animate="fade-up">How Blue Education supports your English journey</h2>
            ...
            <div class="grid sm:grid-cols-2 gap-x-12 gap-y-2">
                <x-icon-list>
                    ...
                    <x-icon-list.item>Student visa guidance and application support</x-icon-list.item>
                </x-icon-list>
                <x-icon-list>
                    <x-icon-list.item>Homestay and accommodation arrangement</x-icon-list.item>
                    <x-icon-list.item>Airport pickup and orientation on arrival</x-icon-list.item>
                    <x-icon-list.item>Ongoing welfare checks and academic progress monitoring</x-icon-list.item>
                </x-icon-list>
            </div>
        </div>
    </section>
