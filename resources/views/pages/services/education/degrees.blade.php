<x-layout title="University Degrees"
    ...
    <section class="bg-base-50">
        <div class="max-w-7xl mx-auto px-8 lg:px-16 py-14">
            ...
            <div class="grid sm:grid-cols-2 gap-6" data-animate="stagger">
                ...
                @endforeach
                <div class="sm:col-span-2 bg-white rounded-corner-lg border border-base-200 p-6 flex items-start gap-5">
                    <img src="{{ asset('images/partners/notre-dame-logo.webp') }}" alt="The University of Notre Dame Australia" class="h-12 w-auto object-contain shrink-0" loading="lazy">
                    <div>
                        <h3 class="font-bold text-base-900 mb-1 text-pretty">The University of Notre Dame Australia</h3>
                        <p class="text-base-600 text-sm leading-relaxed text-pretty">A smaller, values-based university with strengths in health, law, philosophy, and education. Located in Fremantle.</p>
                    </div>
                </div>
            </div>
    ...
    <section class="bg-white">
        <div class="max-w-7xl mx-auto px-8 lg:px-16 py-14">
            ...
            <div class="flex flex-col lg:flex-row items-center gap-12 mb-14">
                <div class="flex-1">
                    <h3 class="text-2xl font-bold text-base-900 mb-4 text-pretty">Global recognition</h3>
                    <p class="text-base-600 leading-relaxed text-pretty">Western Australia's universities are regulated by TEQSA, ensuring consistent academic standards across all programmes. Qualifications are recognised across major economies — including in regulated professions such as teaching, nursing, and engineering.</p>
                </div>
            ...
            <div class="flex flex-col lg:flex-row-reverse items-center gap-12 mb-14">
                <div class="flex-1">
                    <h3 class="text-2xl font-bold text-base-900 mb-4 text-pretty">Industry connections</h3>
                    <p class="text-base-600 leading-relaxed text-pretty">Many programmes include industry placements, research projects, and professional mentoring. Graduates leave with demonstrated experience in their field — not just a transcript.</p>
                </div>
                <div class="flex-1 lg:max-w-[40%]">
            ...
            <div class="flex flex-col lg:flex-row items-center gap-12">
                <div class="flex-1">
                    <h3 class="text-2xl font-bold text-base-900 mb-4 text-pretty">Post-study work rights</h3>
                    <p class="text-base-600 leading-relaxed text-pretty">The Post-Study Work Visa (Subclass 485) gives graduates 2 to 4 years of open work rights in Australia. That's time to build experience in your field, establish professional connections, and consider your options for permanent residence.</p>
    ...
    <section class="bg-base-50">
        <div class="max-w-4xl mx-auto px-8 lg:px-16 py-14 text-center">
            ...
            <p class="text-base-600 leading-relaxed mb-3 text-pretty">Tuition fees vary by institution, field of study, and qualification level. Most universities require fees to be paid per semester or trimester before each study period begins.</p>
            <p class="text-base-600 leading-relaxed mb-6 text-pretty">As an international student, your fees are separate from your living costs. Perth is widely regarded as one of Australia's most liveable and cost-effective cities for students — your advisor can provide a detailed cost breakdown for your specific situation.</p>
