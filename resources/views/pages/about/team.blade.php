<x-layout title="Our Team"
    ...
    @php
        $australianTeam = [
            ...
            ['name' => 'Monica Gaikwad', 'role' => 'Service Manager', 'photo' => 'images/team/monica-gaikwad.webp', 'bio' => 'Monica graduated with a Master of Business Administration from Curtin University and first joined Blue through the Executive Internship Programme, quickly proving herself to be a real asset to the team. She now serves as our Service Manager, overseeing the experience of our onshore clients and business entities, ensuring their needs are consistently understood, responded to and followed through. Originally from India, Monica spent most of her childhood in Kuwait before returning to Mumbai, where she completed a Bachelor of Business, majoring in Accounting and Auditing, at S.N.D.T Women\'s University. In her role as Service Manager, Monica coordinates communication between clients and institutions and relevant stakeholders, monitors service standards, and helps design practical solutions throughout the client engagement support period. She works closely with organisations to clarify their requirements, streamline documentation and follow-up, and make sure that each case progresses smoothly and transparently from start to finish. Beyond work, Monica enjoys cooking, calligraphy and relaxed brunches with friends.', 'credentials' => 'MBA — Curtin University; BBusiness (Accounting & Auditing) — S.N.D.T Women\'s University, Mumbai', 'languages' => 'English, Hindi, Marathi'],
        ];
