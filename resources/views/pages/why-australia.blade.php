<x-layout title="Why Australia"
        ...
        <div class="max-w-7xl mx-auto px-8 lg:px-16 py-14 space-y-14">
            ...
            <div class="flex flex-col lg:flex-row items-center gap-12">
                ...
                <div class="flex-1 lg:max-w-[40%]">
                    <img src="{{ asset('images/why-australia/globally-recognised-qualifications.webp') }}" alt="Diverse international students studying together on a university campus" class="rounded-corner-lg w-full h-auto object-cover aspect-[3/2]" loading="lazy">
                </div>
            </div>
            ...
            <div class="flex flex-col lg:flex-row-reverse items-center gap-12">
                ...
                <div class="flex-1 lg:max-w-[40%]">
                    <img src="{{ asset('images/why-australia/education-choice.webp') }}" alt="Students studying together in a university library with books and resources" class="rounded-corner-lg w-full h-auto object-cover aspect-[3/2]" loading="lazy">
                </div>
            </div>
            ...
            <div class="flex flex-col lg:flex-row items-center gap-12">
                <div class="flex-1">
                    ...
                    <p class="text-gray-600 leading-relaxed mt-4 text-pretty">The Graduate Work Stream provides 18 months for graduates with skills on the relevant occupation lists. Either way, it's a genuine career launchpad.</p>
                </div>
                <div class="flex-1 lg:max-w-[40%]">
                    <img src="{{ asset('images/why-australia/post-study-work.webp') }}" alt="Young professional woman working on a laptop in a modern office environment" class="rounded-corner-lg w-full h-auto object-cover aspect-[3/2]" loading="lazy">
                </div>
            </div>
            ...
            <div class="flex flex-col lg:flex-row items-center gap-12">
                ...
                <div class="flex-1 lg:max-w-[40%]">
                    <img src="{{ asset('images/why-australia/affordable-living.webp') }}" alt="Student working on a laptop at an outdoor cafe, representing affordable student lifestyle" class="rounded-corner-lg w-full h-auto object-cover aspect-[3/2]" loading="lazy">
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="bg-gray-50">
        <div class="max-w-7xl mx-auto px-8 lg:px-16 py-14">
            ...
            <h2 class="text-3xl font-bold text-gray-900 mb-4 text-pretty" data-animate="fade-up">Why Perth.</h2>
        ...
        <div class="max-w-7xl mx-auto px-8 lg:px-16 py-14">
            <div class="grid sm:grid-cols-3 gap-6" data-animate="stagger">
                <div class="border-l-4 border-primary-600 pl-6">
                    <h3 class="font-bold text-gray-900 mb-2">Culturally diverse</h3>
                    <p class="text-gray-600 text-sm leading-relaxed text-pretty">One of the most multicultural countries on earth.</p>
                </div>
                <div class="border-l-4 border-primary-600 pl-6">
                    <h3 class="font-bold text-gray-900 mb-2">English immersion</h3>
                    <p class="text-gray-600 text-sm leading-relaxed text-pretty">Full daily immersion in the global language of business and science.</p>
                </div>
                <div class="border-l-4 border-primary-600 pl-6">
                    <h3 class="font-bold text-gray-900 mb-2">Legal protections</h3>
                    <p class="text-gray-600 text-sm leading-relaxed text-pretty">Strong anti-discrimination laws. International student rights protected at every level.</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <x-cta-banner title="Talk to someone who knows Western Australia."
                  subtitle="Perth-based advisors with 28 years of experience, serving clients from 40+ countries. We'll tell you what fits your situation — no guesswork."
