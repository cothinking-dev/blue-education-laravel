            ...
            <div class="flex flex-col lg:flex-row gap-12">
                <div class="flex-1">
                    ...
                    <div class="bg-amber-50 border border-amber-200 rounded-corner p-4 mt-6">
                        <p class="text-amber-800 text-sm text-pretty"><strong>Professional fields note:</strong> Teaching, nursing, and engineering graduates require registration with the relevant Australian authority (Teaching Council, AHPRA for nursing and allied health, or Engineers Australia) in addition to academic admission. We advise on these requirements as part of your pathway assessment.</p>
                    </div>
                </div>
                <div class="lg:w-[35%]">
                    <div class="bg-primary-50 border-2 border-primary-100 rounded-corner-lg p-8 text-center">
                        ...
                        <p class="text-base-600 text-sm mb-6 text-pretty">Send your transcripts and English test results, and we'll assess your options and recommend the best pathway.</p>
                        <div class="space-y-3">
