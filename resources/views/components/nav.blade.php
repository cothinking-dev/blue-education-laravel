...
>
    ...
    <nav aria-label="Main navigation" class="px-8 py-4 flex items-center justify-between gap-12">
        ...
        <div class="flex items-center gap-3 shrink-0">
            <a href="https://wa.me/{{ config('seo.organization.whatsapp') }}" target="_blank" rel="noopener noreferrer" aria-label="Chat on WhatsApp" class="hidden lg:inline-flex items-center justify-center w-9 h-9 rounded-corner text-primary-500 hover:text-primary-600 hover:bg-primary-50 transition-colors focus:outline-none focus:ring-2 focus:ring-primary-300">
