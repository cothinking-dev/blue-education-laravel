...
class DatabaseSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $testimonials = [
            ['quote' => 'The team went above and beyond, helping me find my course of interest and arrange a scholarship to UWA within 2 weeks.', 'name' => 'N.L.', 'initials' => 'NL', 'credential' => 'Bachelor of Commerce — University of Western Australia', 'country' => 'Malaysia'],
            ['quote' => 'Where would I be without the team at Blue Education? They have helped me so much through my time in Perth, that they are now like family. They are always there for me, whatever I need.', 'name' => 'H.T.', 'initials' => 'HT', 'credential' => 'Master of Business Administration — Curtin University', 'country' => 'Japan'],
            ['quote' => 'Blue Education made my dream of becoming a Registered Nurse come true.', 'name' => 'S.W.', 'initials' => 'SW', 'credential' => 'Bachelor of Nursing — Edith Cowan University', 'country' => 'Singapore'],
            ['quote' => 'My first experience with Blue Education was in 2017, renewing my visa for the first time. Everything was handled in order and in a timely manner. The most organised service I\'ve experienced.', 'name' => 'Z.L.', 'initials' => 'ZL', 'credential' => 'Doctor of Philosophy — Murdoch University', 'country' => 'China'],
            ['quote' => 'They went as far as arranging homestay accommodation and planning out the smoothest course for my next few years of study. My transition to Australia couldn\'t have been easier.', 'name' => 'J.K.', 'initials' => 'JK', 'credential' => 'Foundation Studies — North Metropolitan TAFE', 'country' => 'South Korea'],
        ];
